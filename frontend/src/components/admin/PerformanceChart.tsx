...
export function PerformanceChart({ data, windowDays, onWindowChange }: {
    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={320}>
        <ComposedChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 20 }}>
          ...
          <YAxis
            tick={{ fontSize: 11, fill: "#6b7280" }}
            label={{ value: "GW", angle: -90, position: "insideLeft", offset: 15, fill: "#6b7280", fontSize: 12 }}
          />
          ...
          <Line type="monotone" dataKey="predicted" stroke="#f97316" strokeWidth={2} strokeDasharray="5 3" dot={false} name="Predicted" />
